...
package LeetCode.Medium.StringtoIntegerAtoi;

public class StringToInteger {
    public static void main(String[] args) {
        System.out.println(Solution.myAtoi("-123r"));
        System.out.println(Solution.myAtoi("-r123r"));
        System.out.println(Solution.myAtoi("-123 r"));
        System.out.println(Solution.myAtoi("-123123456789r"));
        System.out.println(Solution.myAtoi("   123r"));
        System.out.println(Solution.myAtoi("+123r"));
        System.out.println(Solution.myAtoi("-123") + 12);
...
class Solution {
    public static int myAtoi(String s) {
        ...
        return to32Bit(stringBuilder);
    }

    private static int to32Bit (StringBuilder s) {
        int result;
        try {
